...
var tables = map[string]Policy{
	...
	"initiative":    {Columns: []string{"entity_id", "name", "initiative", "hp", "hp_max", "hp_temp", "sort_order", "conditions", "effects", "cond_values", "death_saves", "status", "char_id", "campaign_id", "updated_at", "updated_by"}, JSONCols: []string{"conditions", "effects", "cond_values", "death_saves"}, PK: "entity_id", Write: "dm"},
